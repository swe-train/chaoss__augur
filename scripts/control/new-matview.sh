#!/bin/sh
psql -U augur -h localhost -p 5432 -d padres -c "DROP MATERIALIZED VIEW augur_data.explorer_contributor_actions_test;

CREATE MATERIALIZED VIEW augur_data.explorer_contributor_actions_test
AS
SELECT
	x.cntrb_id,
	x.created_at,
...
ALTER MATERIALIZED VIEW augur_data.explorer_contributor_actions_test OWNER TO augur; " 
